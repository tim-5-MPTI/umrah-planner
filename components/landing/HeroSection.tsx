  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden"
      ...
      <div className="absolute right-0 top-0 h-full w-1/2 pointer-events-none">
        <img src="/images/kakbah.png" alt="Ka'bah"
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 md:py-32">
        <div className="max-w-2xl">
          <p className="text-xs md:text-sm font-medium tracking-widest uppercase mb-4 md:mb-6"
            style={{ color: '#735C00' }}>
            Umrah Planner
          </p>
          ...
          <p className="text-base md:text-lg leading-relaxed mb-8 md:mb-10 max-w-lg"
          ...
          <Link href="/planner">
            <button className="px-6 md:px-8 py-3 md:py-4 rounded-2xl font-semibold text-sm md:text-base transition-all hover:opacity-90"
